...
new_stationary = Stationary(
    'Здесь должен быть title для вызова базового класса')
new_stationary.Draw()
...
new_pencil = Pencil(
    'Здесь должен быть title для вызова дочернего класса Pencil')
new_pencil.Draw()

new_handle = Handle(
    'Здесь должен быть title для вызова дочернего класса Handle')
new_handle.Draw()
